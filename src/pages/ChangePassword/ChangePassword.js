    ...
    render() {
        ...
        return (
            <div className="auth-page">
                <Container>
                    <Widget className="widget-auth mx-auto" title={<h3 className="mt-0">Change your Password</h3>}>
                        <p className="widget-auth-info">
                            Use your Current password to create new password .
                        </p>
                        <form onSubmit={this.doLogin}>
                            ...
                            <FormGroup>
                                ...
                                <InputGroup className="input-group-no-border">
                                    ...
                                    <Input id="password" className="input-transparent pl-3" value={this.state.password}
                                           ...
                                           required name="password" placeholder="Current password"/>
                                </InputGroup>
                            </FormGroup>
                            <FormGroup>
                                ...
                                <InputGroup className="input-group-no-border">
                                    ...
                                    <Input id="password" className="input-transparent pl-3" value={this.state.password}
                                           onChange={this.changePassword} type="password"
                                           required name="password" placeholder="New Password"/>
                                </InputGroup>
                            </FormGroup>
                            <FormGroup>
                                ...
                                <InputGroup className="input-group-no-border">
                                    ...
                                    <Input id="password" className="input-transparent pl-3" value={this.state.password}
                                           onChange={this.changePassword} type="password"
                                           required name="password" placeholder="Confirm Password"/>
                                </InputGroup>
                            </FormGroup>
                            <div className="bg-widget auth-widget-footer">
                                <Button type="submit" color="danger" className="auth-btn"
                                  ...
                                  {this.props.isFetching ? 'Loading...' : 'Change Password'}
                                </Button>
